...
function Signup() {
  ...
  return (
    <div className='custom min-h-screen bg-blue-100 flex justify-center items-center flex-col'>
      ...
      <div className='bg-white px-8 py-6 mx-12 shadow-md rounded-lg w-5/6 max-w-2xl'>
