...
function Signup() {
  ...
  return (
    <>
      <div className='custom min-h-screen bg-blue-200 flex justify-center items-center flex-col'>
        ...
        <div className='bg-white px-8 py-6 mx-12 shadow-md rounded-lg w-5/6 max-w-2xl'>
          ...
          <div className='flex items-center justify-center mt-4 space-x-4'>
            ...
            <div className='bg-slate-200 rounded-lg px-10 py-2 hover:bg-blue-200 hover:text-blue-500 cursor-pointer space-x-2'>
        ...
        <div className='my-6'>
          Already have account? <Link className='text-blue-500'>Login</Link>
        </div>
      </div>
    </>
  )
